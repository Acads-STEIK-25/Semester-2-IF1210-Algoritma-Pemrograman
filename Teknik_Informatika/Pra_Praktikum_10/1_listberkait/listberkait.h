 ...
 * 1. Node adalah representasi elemen yang menyimpan data (info) dan tali
 * (next).
 * 2. Address adalah alamat memori dari Node tersebut (pointer ke Node).
 * 3. List adalah nama lain untuk sebuah Address yang menunjuk ke Node pertama
 * (Head). Oleh karena itu, secara teknis Address adalah List. Namun agar tidak
 * salah paham, pada praktikum ini List mengacu pada Address pertama pada suatu
 * stuktur list berkait.
 */
